...
public class Era {
	...
	Era(int numberOfGenerations, int populationSize, int selectionSize, double probabilityConstant, double percentMutation, int searchSpace, int numberOfGenes){
	...
	static Population sortPopulation(Population population){
	 ...
	 * fitness function
	 */
	void evaluate(int generation){//, double diversityWeight, double fitnessWeight){
